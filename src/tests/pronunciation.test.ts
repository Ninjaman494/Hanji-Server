import {
  ...
  consonant_combination_rule,
  change_padchim_pronunciation,
  get_pronunciation,
} from '../korean/pronunciation';

describe('pronunciation functions', () => {
  test('replace eung', async () => {
    expect(move_padchim_to_replace_eung('학', '원')).toEqual(['하', '권']);
  });
